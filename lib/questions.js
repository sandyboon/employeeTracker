...
questions.selectEmployeeToChangeRole = function SelectEmployee() {
  this.message = 'Please select the Employee whose role you wish to change: ';
  this.name = 'empId';
  this.type = 'list';
  this.choices = [];
  this.filter = (val) => {
...
questions.getEmployeeUpdateQuestions = function (employees, roles) {
  let employeeUpdateQuestions = [];
  let selectEmpQues = new this.selectEmployeeToChangeRole();
